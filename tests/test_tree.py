...
def test_allErrorTree():
    ...
    Tree = tree.ovalNode.ovalNode(
        1, 'and', [
            tree.ovalNode.ovalNode(
                2, "error"), tree.ovalNode.ovalNode(
                3, "xor", [
                    tree.ovalNode.ovalNode(
                        4, 'error'), tree.ovalNode.ovalNode(
                            5, 'one', [
                                tree.ovalNode.ovalNode(
                                    6, 'error'), tree.ovalNode.ovalNode(
                                        7, 'error'), tree.ovalNode.ovalNode(
                                            8, 'error')]), tree.ovalNode.ovalNode(
                                                9, 'error')]), tree.ovalNode.ovalNode(
                                                    10, 'or', [
                                                        tree.ovalNode.ovalNode(
                                                            11, "error"), tree.ovalNode.ovalNode(
                                                                12, "error")])])
...
def test_UltimateTree():
    ...
    Tree = tree.ovalNode.ovalNode(
        1, 'and', [
            tree.ovalNode.ovalNode(
                2, "false"), tree.ovalNode.ovalNode(
                3, "xor", [
                    tree.ovalNode.ovalNode(
                        4, 'true'), tree.ovalNode.ovalNode(
                            5, 'one', [
                                tree.ovalNode.ovalNode(
                                    6, 'noteval'), tree.ovalNode.ovalNode(
                                        7, 'true'), tree.ovalNode.ovalNode(
                                            8, 'notappl')]), tree.ovalNode.ovalNode(
                                                9, 'error')]), tree.ovalNode.ovalNode(
                                                    10, 'or', [
                                                        tree.ovalNode.ovalNode(
                                                            11, "unknown"), tree.ovalNode.ovalNode(
                                                                12, "true")])])
